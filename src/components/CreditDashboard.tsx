 ...
 return (
  <div className="space-y-6">
   ...
   {hasActivePermission ? (
    ...
    <Card className="border-indigo-200 bg-gradient-to-r from-indigo-50 to-purple-50 overflow-hidden relative group hover:shadow-lg transition-all duration-300">
   ...
   {hasActivePermission && usagePercentage > 80 && (
    <Card className="border-yellow-500/30 bg-gradient-to-r from-yellow-50 to-orange-50 overflow-hidden relative group hover:shadow-lg transition-all duration-300">
