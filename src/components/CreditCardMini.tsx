 ...
 return (
  <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#6B53FF] via-[#7C5DFF] to-[#FEA611] p-6 text-white shadow-2xl">
   ...
   <div className="relative z-10">
    ...
    <div className="flex items-start justify-between mb-6">
     <div>
      <div className="flex items-center gap-2 mb-1">
       ...
       <span className="text-sm font-medium opacity-90">Pagent Allowance</span>
      </div>
    ...
    {/* Available credit */}
    <div className="mb-4">
     <p className="text-sm opacity-80 mb-1">Available Allowance</p>
     <p className="text-3xl font-bold tracking-tight">
      {formatCurrency(availableCredit)}
     </p>
     <p className="text-sm opacity-70 mt-1">
      of {formatCurrency(totalLimit)} cap
     </p>
    </div>
