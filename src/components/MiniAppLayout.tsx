...
export function MiniAppLayout({ children, title = "Pagent Credits", showWallet = true }: MiniAppLayoutProps) {
 ...
 return (
  <div className="min-h-screen min-h-[100dvh] bg-gradient-to-br from-indigo-50 via-white to-blue-50 flex flex-col">
   {/* Mini-app optimized header */}
   <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-gray-200/50 safe-area-top">
    <div className="max-w-screen-sm mx-auto px-4 py-3 safe-area-x">
     <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
       ...
       <div>
        ...
        <p className="text-xs text-gray-600">Allowance, Not Custody</p>
       </div>
      </div>
         ...
         <div className="flex items-center gap-2">
          <Wallet>
           <WalletDropdown>
            <Identity
             address={address}
             className="px-3 py-2 bg-white rounded-xl border border-gray-200 hover:bg-gray-50 transition-colors"
            >
   ...
   <main className="flex-1 max-w-screen-sm mx-auto px-4 py-6 pb-safe safe-area-x overflow-auto">
   ...
   <div className="fixed bottom-0 left-0 right-0 z-40">
    <div className="max-w-screen-sm mx-auto px-4 py-2">
     <div className="bg-white/90 backdrop-blur-xl rounded-xl border border-gray-200/50 shadow-lg">
